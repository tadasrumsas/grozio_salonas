      ...
      >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-6 gap-2 items-center text-gray-800">
          ...
          <div>
            ...
            {new Date(registration.registration_date).toLocaleDateString("lt-LT")}
          </div>

          {/* Turo pavadinimas */}
          <div>
            <span className="font-semibold lg:hidden">Turas: </span>
            {registration.tour_title}
          </div>
          ...
          <div>
            <span className="font-semibold lg:hidden">Naujas statusas: </span>
            <select
              value={statusUpdates[registration.registration_id] || ""}
              onChange={(e) =>
                handleStatusChange(registration.registration_id, e.target.value)
              }
